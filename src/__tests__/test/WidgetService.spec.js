...
describe('Test widget CRUD operations', ()=>{
    ...
    beforeEach(()=>{
        ...
        Database.serialize(() => {
              SqlDb.setupTables();
              Database.run("REPLACE INTO Widgets(WidgetId, DashboardId, Title, Range, Frequence, ISACTIVE, Position) VALUES(1, 0, 'Widget voor gasverbruik', '24h', 3600, 1, 1);");
              Database.run("REPLACE INTO Widgets(WidgetId, DashboardId, Title, Range, Frequence, ISACTIVE, Position) VALUES(2, 0, 'Widget voor gasverbruik', '24h', 3600, 1, 1);");

              Database.run("REPLACE INTO Graphs (WidgetId, Name, Measurement, Type, Color) VALUES(1, 'Voorbeeld', 'kwh', 'lijn', '#000001')");
              Database.run("REPLACE INTO Graphs (WidgetId, Name, Measurement, Type, Color) VALUES(1, 'Voorbeeld', 'kwh', 'lijn', '#000001')");

              Database.run("REPLACE INTO Graphs (WidgetId, Name, Measurement, Type, Color) VALUES(2, 'Voorbeeld', 'kwh', 'lijn', '#000001')");
      ...
      describe('Update widgets', ()=>{
        test('Update widget', async ()=>{
            const updateBody  = {Title: "Gewijzigde widget", DashboardId: 0, Frequence: 3000, Range: "48h", ISACTIVE: 1, Position: 1};
      ...
      describe('Read widgets', ()=>{
        test('Read one widget', async ()=>{
            ...
            expect(Check.Graphs).toEqual([
                {"Measurement": "m3", "Name": "Een grafiek over gasgeneratie", "Type": null, Color: "#000001","Measurement": "kwh","Name": "Voorbeeld", "Type": "lijn"}, 
                {"Measurement": "m3", "Name": "Een grafiek over gasverbruik", "Type": null, Color: "#000001", "Measurement": "kwh","Name": "Voorbeeld", "Type": "lijn"}
            ]);
        })
