...
describe('Test graph retrieval', ()=>{
    ...
    beforeEach(()=>{
        ...
        Database.serialize(() => {
              ...
              Database.run("INSERT OR IGNORE INTO Widgets(WidgetId, Title, Range, Frequence, ISACTIVE, Position) VALUES(1, 'Widget voor gasverbruik', '24h', 3000, 1, 1);");
              Database.run("INSERT OR IGNORE INTO Widgets(WidgetId, Title, Range, Frequence, ISACTIVE, Position) VALUES(2, 'Widget voor gasverbruik', '24h', 3000, 1, 1);");

              Database.run("INSERT OR IGNORE INTO Graphs(GraphId, WidgetId, Name, Measurement, Type) VALUES(24, 1, 'Een grafiek over gasverbruik', 'm3', 'lijn');");
              Database.run("INSERT OR IGNORE INTO Graphs(GraphId, WidgetId, Name, Measurement, Type) VALUES(25, 1, 'Een grafiek over gasgeneratie', 'm3', 'lijn');");
              Database.run("INSERT OR IGNORE INTO Graphs(GraphId, WidgetId, Name, Measurement, Type) VALUES(26, 2, 'Een grafiek over gasverbruik', 'm3', 'lijn');");
              Database.run("INSERT OR IGNORE INTO Graphs(GraphId, WidgetId, Name, Measurement, Type) VALUES(27, 2, 'Een grafiek over gasgeneratie', 'm3', 'lijn');");
          })
      })
      ...
      describe('Test deletion of graph', ()=>{
        ...
        test('Replace graph', async ()=>{
            const replaceBody  = {Name:"Nieuwe naam" , Type: "Cirkel", Measurement: "m4"}
      ...
      describe('Test update graph', ()=>{
        test('Test successful update', async ()=>{
            const UpdateBody = {Name: "Nieuwe graph", Type: "Circle", Measurement: "m2"};
            const Id = 26;
      ...
      describe('Test Creation', ()=>{
        test('Test successful creation', async ()=>{
            const CreationBody = {Name: "Nieuwe graph", Type: "Circle", Measurement: "m2"};
            const WidgetId = 2;
