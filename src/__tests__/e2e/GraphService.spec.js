...
const GraphConfigService = require("../../services/dashboardconfig/GraphConfig.service");
...
describe("Test graph retrieval", () => {
  ...
  beforeEach(() => {
    ...
    Database.serialize(() => {
      ...
      Database.run(
        "INSERT OR IGNORE INTO Widgets(WidgetId, Title, DefaultRange, Color_Graph) VALUES(1, 'Widget voor gasverbruik', '24h', 'Blue');"
      );
      Database.run(
        "INSERT OR IGNORE INTO Widgets(WidgetId, Title, DefaultRange, Color_Graph) VALUES(2, 'Widget voor gasverbruik', '24h', 'Blue');"
      );

      Database.run(
        "INSERT OR IGNORE INTO Graphs(GraphId, WidgetId, Name, Measurement) VALUES(24, 1, 'Een grafiek over gasverbruik', 'm3');"
      );
      Database.run(
        "INSERT OR IGNORE INTO Graphs(GraphId, WidgetId, Name, Measurement) VALUES(25, 1, 'Een grafiek over gasgeneratie', 'm3');"
      );
      Database.run(
        "INSERT OR IGNORE INTO Graphs(GraphId, WidgetId, Name, Measurement) VALUES(26, 2, 'Een grafiek over gasverbruik', 'm3');"
      );
      Database.run(
        "INSERT OR IGNORE INTO Graphs(GraphId, WidgetId, Name, Measurement) VALUES(27, 2, 'Een grafiek over gasgeneratie', 'm3');"
      );
    });
  });
