...
describe("Test Settings retrieval", () => {
  ...
  beforeEach(() => {
    ...
    Database.serialize(() => {
      ...
      Database.run(
        "REPLACE INTO  Widgets(WidgetId, Title, DefaultRange, Color_Graph) VALUES(1, 'Widget voor gasverbruik', '24h', 'Blue');"
      );
      Database.run(
        "REPLACE INTO  Widgets(WidgetId, Title, DefaultRange, Color_Graph) VALUES(2, 'Widget voor gasverbruik', '24h', 'Blue');"
      );
      Database.run(
        "REPLACE INTO  WidgetSettings (SettingId, Position, ISACTIVE, WidgetId) VALUES(12, 1, 1, 2)"
      );
    });
  });
