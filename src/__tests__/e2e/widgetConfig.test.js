...
//Queries
const WidgetInsert =
  "REPLACE INTO  Widgets(WidgetId, DashboardId, Title, DefaultRange, Color_Graph) VALUES(1, 0, 'Widget voor gasverbruik', '24h', 'Blue');";
const GraphInsert =
  "REPLACE INTO Graphs (WidgetId, Name, Measurement, Type_Graph, GraphId) VALUES(1, 'Voorbeeld', 'kwh', 'lijn', 1)";
const WidgetInsert2 =
  "REPLACE INTO  Widgets(WidgetId, DashboardId, Title, DefaultRange, Color_Graph) VALUES(2, 0, 'Widget voor gasverbruik', '24h', 'Blue');";
const GraphInsert2 =
  "REPLACE INTO Graphs (WidgetId, Name, Measurement, Type_Graph, GraphId) VALUES(2, 'Voorbeeld', 'kwh', 'lijn', 2)";
const SettingsInsert =
  "REPLACE INTO  WidgetSettings (SettingId, Position, ISACTIVE, WidgetId) VALUES(1, 1, 1, 1)";
const SettingsInsert2 =
  "REPLACE INTO  WidgetSettings (SettingId, Position, ISACTIVE, WidgetId) VALUES(2, 1, 1, 2)";
  ...
  it("Lack of text fields should give a warning", function (done) {
    chai
      ...
      .send({
        ...
        Graphs: [
          { GraphId: 1, Measurement: "kwh", Name: "Nieuw", Type_Graph: "Lijn" },
        ],
      })
      .end((err, res) => {
        const response = res.body;
